...
{
    public static bool CheckKeyExists<TKey, TValue>(this IDictionary<TKey, TValue> dict, TKey key)
    {
    ...
    public static TValue FindKey<TKey, TValue>(this IDictionary<TKey, TValue> dict, TKey key)
    {
        if (dict.ContainsKey(key))
        {
            return dict[key];
    ...
    public static bool ValidateKey<TKey, TValue>(
